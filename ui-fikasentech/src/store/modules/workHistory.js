  ...
  async fetchWorkHistory({ commit }) {
    ...
    const response = [
      ...
      },
      {
        ...
        summary:
          "Osiris Trading is a business that powers a global sports book called Betway. In my 2 and a half years at OsirisI served as a developer and I built and maintained and tested the Betway sports betting web applications using Angular7, Kentico CMS HTML CSS and JavaScript consuming REST services. I also assisted QA with setting up a Test Automation framework for Web, iOS and Android Apps. I also built various mini games, leaderboards and promotional splash pages. I also trained a Junior Developer.",
